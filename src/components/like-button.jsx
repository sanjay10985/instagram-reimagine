...
export const SubscribeButton = ({ onClick, text = "", className = "" }) => {
  ...
  return (
    <motion.div className="relative w-fit">
      ...
      <motion.button
        ...
        className={`flex relative justify-center items-center px-3 py-2 rounded-full overflow-hidden
          ...
          {isSubscribed ? (
            ...
            >
              <Heart
                ...
                className={
                  "text-zinc-900"
                  //   isLiked ? "fill-red-500 text-red-500" : "text-zinc-900"
                }
              />
            </motion.div>
          )}
